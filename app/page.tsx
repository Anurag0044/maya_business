...
export default function Home() {
  return (
    <main className="relative h-[100dvh] max-h-[100dvh] w-full flex flex-col justify-between bg-[#060709] overflow-hidden select-none">
      ...
      {/* 3. Main Stage: Hero (Left) & Right Rail (Right) - Constrained to prevent any overflow */}
      ...
      {/* 4. Bottom Social Proof Bar - Guaranteed 100% visible on all viewports */}
